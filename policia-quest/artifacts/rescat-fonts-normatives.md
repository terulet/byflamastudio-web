...
**El rescat està fet.** Cap font del manifest té `fetchStatus: pending-download`: les 43
normes generals que faltaven es van adoptar el 2026-08-24 des d’un paquet portat a mà, i
la taula revisada d’aquest script es conserva com a registre de com tornar-les a baixar.
Què demostra cada referència i què encara no: `content/municipalities/roses/`
`adopcio-normativa-2026-08-24.json` i `artifacts/adopcio-fonts-normatives-2026-08-24.md`.
...
| --- | --- |
| Fonts pendents | **0** |
| Referències del banc en `pending-source-verification` | 26 |
| Preguntes pròpies que en depenen | 0 |
| Microlliçons que en depenen | 0 |
| Preguntes oficials que es podrien explicar | 0 |

### Per prioritat

| Prioritat | Fonts | Criteri |
| --- | --- | --- |
| **P0** | 0 | Pot explicar 5 preguntes oficials o més, o té 10 consumidors o més. |
...
## Registre del rescat — 43 fonts ja adoptades

Aquestes fonts ja tenen còpia local i **no compten com a pendents**. La fitxa es
conserva perquè és el que caldria per tornar-les a baixar: la URL, el format, la mida
esperada, les comprovacions mínimes i els hosts alternatius. Què demostra cada
referència després de la revisió és a `adopcio-normativa-2026-08-24.json`.
...
- **Articles citats pel banc:** 24
- **Consumidors:** 11 preguntes pròpies · 2 microlliçons · 4 temes · **13 en total**
- **Preguntes oficials que podria explicar:** 22
- **Paquet offline:** `llei-16-1991-policies-locals.pdf` · entre 40.000 i 60.000.000 bytes · ha de contenir «policies locals», «Article 25», «Article 24»
- **També pot resoldre a:** portaldogc.gencat.cat — cal tenir-ho a la llista de hosts oficials.
...
- **Articles citats pel banc:** 1, 9, 10
- **Consumidors:** 8 preguntes pròpies · 3 microlliçons · 3 temes · **11 en total**
- **Preguntes oficials que podria explicar:** 13
- **Paquet offline:** `llei-4-2003-seguretat-publica.pdf` · entre 15.000 i 60.000.000 bytes · ha de contenir «seguretat pública», «Article 9», «Article 1»
- **També pot resoldre a:** portaldogc.gencat.cat — cal tenir-ho a la llista de hosts oficials.
...
- **Consumidors:** 12 preguntes pròpies · 3 microlliçons · 5 temes · **15 en total**
- **Preguntes oficials que podria explicar:** 22
...
- **Articles citats pel banc:** 1, 2, 9, 234, 235, 238, 239, 242, 379, 383, 384, 385, 404
- **Consumidors:** 14 preguntes pròpies · 4 microlliçons · 5 temes · **18 en total**
- **Preguntes oficials que podria explicar:** 13
- **Paquet offline:** `lo-10-1995-cp.pdf` · entre 400.000 i 60.000.000 bytes · ha de contenir «Código Penal», «Artículo 379», «Artículo 237», «Artículo 1», «Artículo 2»
  ...
  Afirmacions que ha de demostrar (mostra):
  - `q-roses-t25-005` · *art. 404 i 390* — Que, en el punt citat, la resposta a «Un company t’explica que ha «arreglat» una denúncia a un conegut. Segons els principis ètics i deontològics, això és:» és «Un tracte de favor prohibit que pot constituir falta disciplinària i, segons el cas, delicte».
...
- **Articles citats pel banc:** 1, 5, 9, 31, 53
- **Consumidors:** 7 preguntes pròpies · 1 microlliçons · 3 temes · **8 en total**
- **Preguntes oficials que podria explicar:** 12
- **Paquet offline:** `lo-2-1986-fcs.pdf` · entre 120.000 i 60.000.000 bytes · ha de contenir «Fuerzas y Cuerpos de Seguridad», «Artículo 5», «Artículo 1»
  ...
  Afirmacions que ha de demostrar (mostra):
  - `q-roses-t08-003` · *art. 5.1* — Que, en el punt citat, la resposta a «El deure d’obediència d’un empleat públic cedeix quan la instrucció rebuda:» és «Constitueix una infracció manifesta de l’ordenament jurídic».
...
- **Articles citats pel banc:** 104, 105, 106
- **Consumidors:** 6 preguntes pròpies · 2 microlliçons · 2 temes · **8 en total**
- **Preguntes oficials que podria explicar:** 8
- **Paquet offline:** `rdleg-6-2015-ltsv.pdf` · entre 300.000 i 60.000.000 bytes · ha de contenir «Tráfico», «Seguridad Vial», «Artículo 104», «Artículo 105»

  Afirmacions que ha de demostrar (mostra):
  - `q-roses-t32-001` · *art. 104 i 105* — Que, en el punt citat, la resposta a «Quina diferència hi ha entre immobilització i retirada d’un vehicle?» és «La immobilització deixa el vehicle al lloc sense poder circular; la retirada el trasllada al dipòsit».
  - `q-roses-t32-002` · *art. 106.1.a* — Que, en el punt citat, la resposta a «Quan es presumeix que un vehicle està abandonat per romandre al dipòsit?» és «Quan hi ha estat més de dos mesos».
  - `q-roses-t32-003` · *art. 104.1.d* — Que, en el punt citat, la resposta a «Quina d’aquestes és causa d’immobilització d’un vehicle?» és «Que el conductor superi la taxa d’alcohol permesa o es negui a les proves».
  - …i 5 més, totes al JSON.
...
- **Articles citats pel banc:** 2
- **Consumidors:** 4 preguntes pròpies · 1 microlliçons · 1 temes · **5 en total**
- **Preguntes oficials que podria explicar:** 3
- **Paquet offline:** `decret-151-1998-juntes.pdf` · entre 30.000 i 60.000.000 bytes · ha de contenir «juntes locals de seguretat», «Article 2»
- **També pot resoldre a:** portaldogc.gencat.cat — cal tenir-ho a la llista de hosts oficials.
  ...
  - `q-roses-t23-003` · *art. 2* — Que, en el punt citat, la resposta a «Quina d’aquestes és una funció pròpia de la junta local de seguretat?» és «Analitzar la situació de seguretat, aprovar el pla local de seguretat i fixar criteris de coordinació».
  - `q-roses-t23-004` · *norma reguladora* — Que, en el punt citat, la resposta a «Quina norma regula específicament les juntes locals de seguretat a Catalunya?» és «El Decret 151/1998, de 23 de juny».
  - …i 2 més, totes al JSON.
...
- **Articles citats pel banc:** 544
- **Consumidors:** 3 preguntes pròpies · 1 microlliçons · 1 temes · **4 en total**
- **Paquet offline:** `llei-27-2003-ordre-proteccio.pdf` · entre 20.000 i 60.000.000 bytes · ha de contenir «orden de protección», «Artículo 544»
...
- **Paquet offline:** `llei-53-1984-incompat.pdf` · entre 60.000 i 60.000.000 bytes · ha de contenir «incompatibilidades», «Artículo 14», «Artículo 1», «Artículo 3»
  ...
  - `q-roses-t09-002` · *art. 16.4* — Que, en el punt citat, la resposta a «No es pot autoritzar la compatibilitat per a activitats privades quan el complement específic o concepte equiparable supera:» és «El 30 % de la retribució bàsica, exclosa l’antiguitat».
...
- **Paquet offline:** `rdleg-5-2015-trebep.pdf` · entre 150.000 i 60.000.000 bytes · ha de contenir «empleado público», «Artículo 52», «Artículo 8», «Artículo 14»
  ...
  - `q-roses-t08-003` · *art. 54* — Que, en el punt citat, la resposta a «El deure d’obediència d’un empleat públic cedeix quan la instrucció rebuda:» és «Constitueix una infracció manifesta de l’ordenament jurídic».
  - …i 4 més, totes al JSON.
...
- **Duplicitat:** No és paraigua: baixat el 2026-08-24, el recull resulta ser un **índex d’enllaços** —els catorze apartats, de «Constitució i Estatut» a «Organismes», amb el títol de cada norma— i no el text de cap. Serveix de punt d’entrada per trobar-les; cada norma ha de seguir baixant-se a part i conserva el seu `sourceId`.
...
font ja té còpia local amb el hash comprovat. Tenir el document no verifica la cita: o bé
la descàrrega no en porta el text, o bé el document no diu el que la referència afirma.
El motiu de cada una és a `adopcio-normativa-2026-08-24.json`, camp `verdict`:

- `q-roses-t04-005` → `llei-4-2003-seguretat-publica`
- `q-roses-t19-001` → `agencia-ciberseguretat-catalunya`
- `q-roses-t19-002` → `agencia-ciberseguretat-catalunya`
- `q-roses-t19-003` → `agencia-ciberseguretat-catalunya`
- `q-roses-t19-004` → `agencia-ciberseguretat-catalunya`
- `q-roses-t19-005` → `agencia-ciberseguretat-catalunya`
- `q-roses-t31-001` → `roses-web-municipi`
- `q-roses-t31-002` → `roses-web-municipi`
- `q-roses-t31-003` → `roses-web-municipi`
- `q-roses-t31-004` → `roses-web-municipi`
- `q-roses-t31-005` → `roses-web-municipi`
- `q-roses-t31-006` → `roses-web-municipi`
- `q-roses-t34-005` → `llei-7-2023-benestar-animal`
- `q-roses-t31-101` → `roses-web-municipi`
- `q-roses-t31-102` → `roses-web-municipi`
- `q-roses-t31-103` → `roses-web-municipi`
- `q-roses-t31-104` → `roses-web-municipi`
- `q-roses-t31-105` → `roses-web-municipi`
- `q-roses-t31-106` → `roses-web-municipi`
- `q-roses-t31-107` → `roses-web-municipi`
- `q-roses-t31-108` → `roses-web-municipi`
- `q-roses-t01-101` → `ce-1978`
- `q-roses-t01-102` → `ce-1978`
- `q-roses-t04-102` → `lo-6-2006-eac`
- `roses-t19-l1` → `agencia-ciberseguretat-catalunya`
- `roses-t31-l1` → `roses-web-municipi`

## Validacions

| # | Comprovació | Resultat |
| --- | --- | --- |
| 1 | Totes les fonts pendents són a l’inventari | ✓ Cap font amb fetchStatus pending-download: totes tenen còpia local. La taula ENRICHMENT es conserva com a registre del rescat. |
| 2 | Cap referència pendent d’una font inventariada es queda fora | ✓ 26 referències pendents en total; 0 apunten a fonts inventariades i totes hi consten. 26 apunten a fonts ja adoptades i queden anotades com a troballa. |
| 3 | Cap font ja baixada no s’ha colat a l’inventari | ✓ Les 0 entrades tenen fetchStatus pending-download al manifest. |
| 4 | Cap afirmació de l’inventari apunta a una pregunta o lliçó que ja no existeix | ✓ 439 preguntes i 40 lliçons resolen tots els consumidors; empremta de contingut: 7eae9a6321ec0b1f… |
| 5 | La taula revisada i les dades reals quadren exactament | ✓ 43 entrades corresponen a fonts ja rescatades i es conserven com a registre; cap entrada desconeguda. |

Empremta del contingut (identificadors, temes, claus i explicacions de les
439 preguntes): `7eae9a6321ec0b1fbd99eeb531cd7a29a85449be4fba9d69dfd552fc203a931e`.
